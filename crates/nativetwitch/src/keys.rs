...
// whitespace-separated identifiers (`NativeTwitch Watch`), while a *predicate*
// is a boolean expression over them (`NativeTwitch && Watch`). Interpolating a
...
pub const CONTEXT_WATCH: &str = "NativeTwitch Watch";
pub const CONTEXT_BROWSE: &str = "NativeTwitch Browse";
pub const CONTEXT_MODAL: &str = "NativeTwitch Modal";
...
///
/// Kept beside the bindings rather than in the view, because a key that is
/// documented but not bound is worse than one that is neither.
